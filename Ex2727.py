...
O seu objetivo é criar um programa que decifre as mensagens secretas e ajudar
 Jaqueline e Laura descobrirem o que Joana e Bruna estão planejando.
...
def decodifica(codigo, codigo_alfabeto):
    return codigo_alfabeto[codigo]
